...
public class ModifierSalle extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jComboBoxTYPE, javax.swing.GroupLayout.Alignment.LEADING, 0, 100, Short.MAX_VALUE))
                        .addGap(25, 25, 25)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButtonENREGISTRERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonENREGISTRERActionPerformed
        ...
        else if(Salle.RechercherSalleParNom(jTextFieldNom.getText()).getNom()!=null && !Salle.RechercherSalleParNom(jTextFieldNom.getText()).getNom().equals(jTextFieldNom.getText())){
        ...
        if(jLabel4.isVisible()==false &&  jLabel3.isVisible()== false){
            Salle S;
            S = new Salle();
            S.setId(Conversion.StringtoInt(jTextFieldID.getText()));
            S.setNom(jTextFieldNom.getText());
            S.setType(jComboBoxTYPE.getSelectedItem().toString());
            if(S.ModifierSalle(S.getId())){
                JOptionPane.showMessageDialog(null, "La salle a été modifié avec succes!");
                dispose();
