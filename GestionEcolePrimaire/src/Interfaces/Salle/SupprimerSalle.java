...
public class SupprimerSalle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Voulez-vous vraiment supprimer cette Salle?");
    ...
    private void jButtonCONFIRMERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCONFIRMERActionPerformed
        // TODO add your handling code here:
        Salle i=new Salle();
        if(i.SupprimerSalle(Conversion.StringtoInt(jTextFieldID.getText()))){
                JOptionPane.showMessageDialog(null, "La salle a été supprimé avec succes!");
                dispose();
            ...
            else JOptionPane.showMessageDialog(null, "Echec de suppression de la salle!");
